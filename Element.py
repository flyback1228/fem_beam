...
class ElementCupy:
    def __init__(self,id:int,n1:Node,n2:Node,E,A,I,rho) -> None:
        ...
        self.Ke = E/l*cp.array([ [ A,           0,        0, -A,            0,        0],
                               [ 0, 12*(I/l**2),  6*(I/l),  0, -12*(I/l**2),  6*(I/l)],
                               [ 0,     6*(I/l),      4*I,  0,     -6*(I/l),      2*I],
                               [-A,           0,        0,  A,            0,        0],
                               [ 0,-12*(I/l**2), -6*(I/l),  0,  12*(I/l**2), -6*(I/l)],
        ...
        self.Me = rho*A*l/420*cp.array([[140,      0,      0,      70,     0,      0],
                                        [0,         156,    22*l,   0,      54,     -13*l],
                                        [0,         22*l,   4*l*l,  0,      13*l, -3*l*l],
                                        [70,        0,      0,      140,    0,      0],
                                        [0,         54,     13*l,   0,      156,    -22*l],
        ...
        self.Kg = cp.matmul(cp.matmul(cp.transpose(self.T),self.Ke),self.T)
        self.Mg = cp.matmul(cp.matmul(cp.transpose(self.T),self.Me),self.T)
